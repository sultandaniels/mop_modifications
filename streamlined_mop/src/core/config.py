...
class Config(object, metaclass=Singleton):
    ...
    # Dataset settings
    num_tasks = 7#40000 #number of training systems
    ...
    ny = 5
    n_noise = 1
    num_traces = {"train": 1, "val": 5}#2000}

    # Training settings
    train_steps = 1 #192000 #number of training steps
    train_int = 1 #4000 #number of steps between logging (MAKE SURE THIS IS <= TRAIN STEPS)
