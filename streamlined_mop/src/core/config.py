...
class Config(object, metaclass=Singleton):
    ...
    dataset_typ = "rotDiagA_gauss" #"unifA" #"gaussA" #"gaussA_noscale" #"rotDiagA" #"rotDiagA_unif" #"rotDiagA_gauss" #"upperTriA" #"single_system" #"cond_num"
    max_cond_num = 100
    distinct_cond_nums = 10
    val_dataset_typ = "rotDiagA_gauss"  #"unifA" #"gaussA" #"gaussA_noscale" #"rotDiagA" #"rotDiagA_unif" #"rotDiagA_gauss" #"upperTriA" #"single_system" #"cond_num"
