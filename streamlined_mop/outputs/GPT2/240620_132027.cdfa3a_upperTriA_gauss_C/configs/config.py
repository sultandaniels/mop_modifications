...
class Config(object, metaclass=Singleton):
    ...
    # Dataset settings
    num_tasks = 1000 #number of training systems
    num_val_tasks = 3 #number of test systems
    dataset_typ = "upperTriA" #"unifA" #"gaussA" #"rotDiagA" #"upperTriA"
    ...
    # Training settings
    train_steps = 400 #number of training steps
    train_int = 100 #number of steps between logging
