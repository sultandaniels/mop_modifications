...
class DroneState:
    limits = np.array([[DroneConfig.xmin, DroneConfig.zmin, DroneConfig.phimin, DroneConfig.vxmin, DroneConfig.vzmin,
                        DroneConfig.phidotmin],
                       [DroneConfig.xmax, DroneConfig.zmax, DroneConfig.phimax, DroneConfig.vxmax, DroneConfig.vzmax,
                        DroneConfig.phidotmax]], dtype="f")
    ...
    def __repr__(self):
        return "x: {:.3f}, z:{:.3f} phi:{:.3f} vx:{:.3f} vz:{:.3f}, phiddot:{:.3f}".format(self.x, self.z, self.phidot,
                                                                                           self.vx, self.vz,
                                                                                           self.phiddot)
...
def generate_drone_sample(n_positions, m_rng=(0.5, 2), l_rng=(0.5, 2), J_rng=(0.5, 2), dt=1e-1, sigma_w=1e-1,
                          sigma_v=1e-1):
